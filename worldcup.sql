...
--
-- Name: teams_teamid_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--
...
ALTER TABLE public.teams_teamid_seq OWNER TO freecodecamp;
...
--
-- Name: teams_teamid_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.teams_teamid_seq', 24, true);
